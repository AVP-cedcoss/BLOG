...
class Blogs
{
    ...
    {
        $this -> db -> query("
        SELECT `Blog_ID`, `Blog_Name`, `Name`, `Blog_Status` FROM 
        `Blogs`, `User_Details` WHERE `Blog_Author_ID` = `User_ID`;
        ");
    ...
    {
        $this -> db -> query("
        SELECT `Blog_ID`, `Blog_Name`, `Blog_Content`, `Name`, `Blog_Status` FROM 
        `Blogs`, `User_Details` WHERE `Blog_Author_ID` = `User_ID`;
        ");
